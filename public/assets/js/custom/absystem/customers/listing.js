...
var KTCustomersList = function () {
    ...
    const c = () => {
        const
            t = document.querySelector('[data-kt-customer-table-toolbar="base"]'),
        ...
        let r = !1, l = 0; 
        c.forEach((t => { t.checked && (r = !0, l++) })), 
        r ? (n.innerHTML = l, 
            t.classList.add("d-none"), 
            o.classList.remove("d-none")) : (t.classList.remove("d-none"), o.classList.add("d-none"))
    }; 
    return {
        init: function () {
            (e = document.querySelector("#kt_customers_table"))
                ...
                (e.querySelectorAll("tbody tr").forEach((t => {
                    ...
                    })).on("draw", (function () { n(), o(), c() })), n(),
                    document.querySelector('[data-table-filter="search"]').addEventListener("keyup",
                        (function (e) {
                            t.search(e.target.value).draw()
                        })), o(), (() => {
                            const
                                e = document.querySelector('[data-kt-ecommerce-order-filter="status"]');
                            $(e).on("change",
                                (e => { let o = e.target.value; "all" === o && (o = ""), t.column(3).search(o).draw() }))
                        })())
        }
    }
}();
